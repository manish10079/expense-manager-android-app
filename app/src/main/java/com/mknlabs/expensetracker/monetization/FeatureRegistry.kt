...
enum class Feature(val id: String, val displayName: String) {
    ...
    BUDGET_COPY_PREVIOUS_MONTH("budget_copy_previous_month", "Copy Previous Month Budgets"),
...
object FeatureRegistry {
    ...
    private val registry = mapOf<Feature, Any>(
        ...
        Feature.BUDGET_COPY_PREVIOUS_MONTH to AccessLevel.PREMIUM,
        ...
        Feature.CARD_CUSTOMIZATION to mapOf(
            ...
            "showTransactionTime" to AccessLevel.FREE,
