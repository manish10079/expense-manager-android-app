...
object AppSettingsDataStore {
    ...
    private object Keys {
        ...
        val largeTransactionAlertsEnabled = booleanPreferencesKey("large_transaction_alerts_enabled")
        val weeklySummaryEnabled = booleanPreferencesKey("weekly_summary_enabled")
        val financialInsightsEnabled = booleanPreferencesKey("financial_insights_enabled")
        val savingsGoalsEnabled = booleanPreferencesKey("savings_goals_enabled")
        val billRemindersEnabled = booleanPreferencesKey("bill_reminders_enabled")
        val cloudSecurityEnabled = booleanPreferencesKey("cloud_security_enabled")
        val largeTransactionThresholdMinor = longPreferencesKey("large_transaction_threshold_minor")
        val weeklySummaryTimeMillis = longPreferencesKey("weekly_summary_time_millis")
    ...
    private fun Preferences.toAppSettings(): AppSettings {
        return AppSettings(
            ...
            largeTransactionAlertsEnabled = this[Keys.largeTransactionAlertsEnabled] ?: defaultAppSettings.largeTransactionAlertsEnabled,
            weeklySummaryEnabled = this[Keys.weeklySummaryEnabled] ?: defaultAppSettings.weeklySummaryEnabled,
            financialInsightsEnabled = this[Keys.financialInsightsEnabled] ?: defaultAppSettings.financialInsightsEnabled,
            savingsGoalsEnabled = this[Keys.savingsGoalsEnabled] ?: defaultAppSettings.savingsGoalsEnabled,
            billRemindersEnabled = this[Keys.billRemindersEnabled] ?: defaultAppSettings.billRemindersEnabled,
            cloudSecurityEnabled = this[Keys.cloudSecurityEnabled] ?: defaultAppSettings.cloudSecurityEnabled,
            largeTransactionThresholdMinor = this[Keys.largeTransactionThresholdMinor] ?: defaultAppSettings.largeTransactionThresholdMinor,
            weeklySummaryTimeMillis = this[Keys.weeklySummaryTimeMillis] ?: defaultAppSettings.weeklySummaryTimeMillis,
    ...
    private fun MutablePreferences.writeAppSettings(settings: AppSettings) {
        ...
        this[Keys.largeTransactionAlertsEnabled] = settings.largeTransactionAlertsEnabled
        this[Keys.weeklySummaryEnabled] = settings.weeklySummaryEnabled
        this[Keys.financialInsightsEnabled] = settings.financialInsightsEnabled
        this[Keys.savingsGoalsEnabled] = settings.savingsGoalsEnabled
        this[Keys.billRemindersEnabled] = settings.billRemindersEnabled
        this[Keys.cloudSecurityEnabled] = settings.cloudSecurityEnabled
        this[Keys.largeTransactionThresholdMinor] = settings.largeTransactionThresholdMinor
        this[Keys.weeklySummaryTimeMillis] = settings.weeklySummaryTimeMillis
