...
import com.mkn0079.expensetracker.domain.repository.BudgetRepository as DomainBudgetRepository
...
class BudgetRepository(context: Context) : DomainBudgetRepository {
